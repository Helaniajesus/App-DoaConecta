...
class SenhaSMSPageOng extends StatelessWidget {
  const SenhaSMSPageOng({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Senha via SMS"),
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              "Um código foi enviado para o seu número de telefone",
