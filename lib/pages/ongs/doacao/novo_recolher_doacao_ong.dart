...
class NovoRecolherDoacaoPage extends StatefulWidget {
  final Donation donation;

  NovoRecolherDoacaoPage({required this.donation});

  @override
  _NovoRecolherDoacaoPageState createState() => _NovoRecolherDoacaoPageState();
}
  
class _NovoRecolherDoacaoPageState extends State<NovoRecolherDoacaoPage> {
              ...
              onPressed: () async {
                ...
                if (data.isNotEmpty && horario.isNotEmpty) {
                  ...
                  if (user != null) {
                    ...
                    await atualizarDadosRecolhimentoNoFirestore(alerta);
